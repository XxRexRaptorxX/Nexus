...
public class Config {
    ...
    public static void initServer() {
        ...
        NEXUS_SAFE_ZONE = builder.comment("The radius of the zone around a Nexus where no block can be placed [0 = disabled] (large values cost performance)")
        ...
        NEXUS_REWARDS = builder.comment("A list with all the rewards that drop when a Nexus is destroyed [amount*modid:item]").define("nexus_rewards",
                new ArrayList<>(Arrays.asList("1*" + BuiltInRegistries.ITEM.getKey(Items.NETHER_STAR).toString())));
        ...
        NEXUS_EFFECT_WHEN_RIGHT_CLICKED = builder.comment("Should the Nexus spawn a area effect cloud with damage boost when right clicked?")
        ...
        SUPPLY_CRATE_LOOT = builder.comment("A list with all the loot that can drop when a Supply Crate is destroyed [amount*modid:item]").define("supply_crate_loot",
                new ArrayList<>(Arrays.asList("1*" + BuiltInRegistries.ITEM.getKey(Items.IRON_SWORD).toString(),
                        "1*" + BuiltInRegistries.ITEM.getKey(Items.DIAMOND_SWORD).toString(), "1*" + BuiltInRegistries.ITEM.getKey(Items.TRIDENT).toString(),
                        "1*" + BuiltInRegistries.ITEM.getKey(Items.DIAMOND_HELMET).toString(), "1*" + BuiltInRegistries.ITEM.getKey(Items.DIAMOND_CHESTPLATE).toString(),
                        "1*" + BuiltInRegistries.ITEM.getKey(Items.DIAMOND_LEGGINGS).toString(), "1*" + BuiltInRegistries.ITEM.getKey(Items.DIAMOND_BOOTS).toString(),
                        "1*" + BuiltInRegistries.ITEM.getKey(Items.IRON_HELMET).toString(), "1*" + BuiltInRegistries.ITEM.getKey(Items.IRON_CHESTPLATE).toString(),
                        "1*" + BuiltInRegistries.ITEM.getKey(Items.IRON_LEGGINGS).toString(), "1*" + BuiltInRegistries.ITEM.getKey(Items.IRON_BOOTS).toString(),
                        "1*" + BuiltInRegistries.ITEM.getKey(Items.CROSSBOW).toString(), "3*" + BuiltInRegistries.ITEM.getKey(Items.GOLDEN_APPLE).toString(),
                        "1*" + BuiltInRegistries.ITEM.getKey(Items.ENCHANTED_GOLDEN_APPLE).toString(), "15*" + BuiltInRegistries.ITEM.getKey(Items.BREAD).toString(),
                        "5*" + BuiltInRegistries.ITEM.getKey(Items.TNT).toString(), "5*" + BuiltInRegistries.ITEM.getKey(Items.ENDER_PEARL).toString(),
                        "10*" + BuiltInRegistries.ITEM.getKey(Items.IRON_INGOT).toString(), "10*" + BuiltInRegistries.ITEM.getKey(Items.GOLD_INGOT).toString(),
                        "3*" + BuiltInRegistries.ITEM.getKey(Items.DIAMOND).toString(), "4*" + BuiltInRegistries.ITEM.getKey(Items.EXPERIENCE_BOTTLE).toString(),
                        "1*" + BuiltInRegistries.ITEM.getKey(Items.DIAMOND_AXE).toString(), "1*" + BuiltInRegistries.ITEM.getKey(Items.DIAMOND_PICKAXE).toString(),
                        "1*" + BuiltInRegistries.ITEM.getKey(Items.IRON_AXE).toString(), "1*" + BuiltInRegistries.ITEM.getKey(Items.IRON_PICKAXE).toString(),
                        "1*" + BuiltInRegistries.ITEM.getKey(Items.SHIELD).toString(), "10*" + BuiltInRegistries.ITEM.getKey(Items.WIND_CHARGE).toString()

...
public class CreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN_TAB = CREATIVE_MODE_TABS.register(References.MODID,
            () -> CreativeModeTab.builder().title(Component.translatable("itemGroup." + References.MODID + "_tab"))
                    .icon(() -> ModBlocks.NEXUS_GREEN.get().asItem().getDefaultInstance()).displayItems((params, output) -> {
